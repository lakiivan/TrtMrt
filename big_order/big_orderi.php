...
<body>
  ...
  <div class="container">
    <div class="row">
      <div class="span12">
        <button class="btn btn-large btn-xxl" id="btn_novkontakt" onclick="location.href='https://localhost/trt_mrt/big_order/big_order_form.php'">Nova Velika Porudžbina</button>
        <?php
